...
import { pubSub, EventMap } from '@/utils/pubsub';
...
export function usePubSub() {
   ...
   */
  const subscribeOne = useCallback(<K extends keyof EventMap>(
    event: K,
  ...
  const subscribe = useCallback((
    eventOrSubscriptions: 
      | keyof EventMap 
      | Array<{ event: keyof EventMap; callback: (data: any) => void }>
    ,
   ...
   */
  const waitFor = useCallback(<K extends keyof EventMap>(
    event: K,
    timeout?: number
  ) => {
