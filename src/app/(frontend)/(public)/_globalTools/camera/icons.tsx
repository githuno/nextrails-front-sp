...
const SwitchCameraIcon: React.FC<IconProps> = ({ size = "24px", color = "#4B4B4B", strokeColor, strokeWidth }) => (
  ...
  >
    {/* Main body */}
    <path
      d="M0 0 C25.2 0 25.2 0 27.58 1.56 C29.12 3.84 29.98 6.17 30.88 8.77 C32.69 14.2 32.69 14.2 32.69 16.2 H53.69 V81.2 H-35.31 V17.2 H-14.31 C-11.41 5.52 -10.64 3.42 -9.31 1.2 C-6.33 -0.29 -3.27 0 0 0 Z"
      fill={color}
      transform="translate(103.309 39.797)"
    />
    {/* Inner details */}
    <path
      d="M-3.31 8.2 L-9.31 23.2 L-28.31 24.2 V73.2 H46.69 V24.2 L27.69 23.2 L21.69 8.2 Z"
      fill="#000"
      transform="translate(103.309 39.797)"
    />
    {/* Left arm */}
    ...
    />
    {/* Center button */}
    <rect x="108" y="83" width="9" height="10" fill="#EEEEEE" />
  </svg>
)
