...
// エリアID型定義
export type AreaId = (typeof areaListParRegion)[RegionId][number]["id"] | "none"
...
export const areaIdToNameMap: Record<AreaId, string> = Object.entries(areaListParRegion).reduce(
  (map, [, areas]) => {
    // 各地域の各エリアについて
    areas.forEach((area) => {
